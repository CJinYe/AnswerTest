        ...
        for (LINE aContentList : contentList) {
            ...
            for (int j = 0; j < aContentList.line.size(); j++) {
                ...
                if (ob instanceof String) {
                    ...
                    //                    if (aContentList.height > contentList.get(0).height) {
                    //                        float textX = (float) (height + (aContentList.height - paint.getFontMetrics().descent + contentList.get(0).height) / 2.15);
                    //                        canvas.drawText((String) ob, realDrawedWidth, textX, paint);
                    //                    } else {
                    //                        canvas.drawText((String) ob, realDrawedWidth, y, paint);
                    //                    }
...
//                            float textY = (height + ((aContentList.height - paint.getFontMetrics().descent) + picHeight / 2) / 2);
