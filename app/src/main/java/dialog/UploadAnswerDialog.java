 ...
 * @updateDes ${TODO}
 */
public abstract class UploadAnswerDialog extends Dialog implements View.OnClickListener{

    private Context mContext;
    private TextView mTextView;

    public UploadAnswerDialog(@NonNull Context context) {
